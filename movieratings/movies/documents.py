...
class MoviesDocument(Document):
    ...
    release_date = fields.DateField(attr='release_date',)
...
class MoviesDocumentViewSet(DocumentViewSet):
    ...
    ordering = ('release_date', 'rating', 'name')
    filter_fields = {
        'genres': {
            'field': 'genres',
            'lookups': (
...
class SearchAPI(APIView):
    def get(self, request):
        data_list = []
        movie_data = MoviesDocumentViewSet.as_view({'get': 'list'})(request._request).data
        tvshow_data = TVShowDocumentViewSet.as_view({'get': 'list'})(request._request).data
        celebrity_data = CelebritiesDocumentViewSet.as_view({'get': 'list'})(request._request).data
        data_list.append(movie_data)
        data_list.append(tvshow_data)
        data_list.append(celebrity_data)
